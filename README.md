...
# Step 2
# ======
# Predict equivalence vs divergences using divergentmBERT trained 
...
# and divergence (results under data/wikimatrix)

'''sbatch --array=0 equivalence-vs-divergence-slurm-array-jobs.sh en fr extract'''

# Step 3a
# =======
# Prepare divergent data for token-level predictions
# (parallelize using SLURM array jobs on the CLIP cluster)
# within CPU node
'''bash divergence-for-parallel.sh en fr'''

# Step 3b
# =======
# DivergentmBERT predictions
...
# Step 4
# ======
# Prepare equivalent data for synthetic divergence generation
# (augment with word alignment tags, prepare for parallelization)
# within CPU node
...
# Step 5
# ======
# Create *Subtree deletion* divergences
# Note: No *need* to parallelize
# run inside CPU node
'''bash r-or-d-divergences.sh en fr d'''

# Create *Phrase replacement* divergences
# Note: *avoid* parallelization; this process highly depends on how we batchify seeds
...
# Step 6
# ======
# Create generalization and particularization instances (Lexical Substitution)
...
# Step 7 
# ======
# Preprocess extracted equivalents vs divergent data
